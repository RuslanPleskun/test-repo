export class ItemsPage {
   ...
   */
  verifyFilterCorrectness(priceFrom, priceTo) {
    ...
    this.getPriceValue().then(($elements) => {
      ...
      cy.wrap(pricesArray).should((prices) => {
        const condition = prices.every((price) => price >= priceFrom && price <= priceTo);
